# Capability: cicd-velocity-metric

## Purpose

Answers "is our automation keeping pace with our code?" by comparing GitHub Actions run frequency against commit frequency on the connected repository's default branch, bucketed by week over the last 12 weeks. Surfaces the result as a CI/CD Velocity panel on the Insights page and folds its score into the team's QA health score.
