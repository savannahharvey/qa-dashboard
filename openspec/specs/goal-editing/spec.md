# Capability: goal-editing

## Purpose

Enables users to edit an existing goal's fields from the dashboard, via a pre-populated edit form and a supporting API endpoint that validates and persists the update.
